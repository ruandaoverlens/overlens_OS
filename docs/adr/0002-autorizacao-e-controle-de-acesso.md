...
- O banco Supabase é compartilhado entre dev, preview e produção, então qualquer mudança de policy precisa ser testada com cuidado antes de ir para produção, já que afeta os três ambientes ao mesmo tempo.
