...
- O leitor (um empreendedor — venha da engenharia, da arquitetura, da arte, do design, de nenhuma dessas origens; ou alguém do time interno) sabe como usar esta informação?
...
- Afirmações estratégicas estão classificadas — DEFINIDO / EM VALIDAÇÃO / HIPÓTESE / HISTÓRICO / PENDENTE? Na dúvida entre DEFINIDO e EM VALIDAÇÃO, vale EM VALIDAÇÃO
...
1. Sempre leia `.claude/rules/tese-atual.md` antes de revisar — ela prevalece sobre qualquer documento da base
