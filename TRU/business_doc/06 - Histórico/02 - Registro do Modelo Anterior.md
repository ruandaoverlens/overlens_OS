...
## Categoria declarada anteriormente
...
## Segmentação anterior do público

Cinco perfis que mediam **a distância entre a ideia e a realidade**, tratados como estágios sequenciais de maturidade do cliente:

| Perfil | Condição |
| :---- | :---- |
| Inconscientes | Carregam ideias há anos, nunca tiraram nenhuma do papel |
| Operantes | Executam bem, acumulam começos, não lançam |
| Convergentes | Lançam, mas cada entrega recomeça do zero |
...
## Ofertas e preços documentados anteriormente

| Produto | Tipo declarado | Preço registrado |
| :---- | :---- | :---- |
| **Atlas** | Front-end / Ingresso | R$19 a R$79 por lote; gravação R$197 |
| **Overpass** | Back-end / Assinatura | R$180/mês · 12x R$149 anual · R$1.500 à vista |
| **Vanguarda** | High-end / Mentoria | R$12.000 ou 12x R$1.000; especial R$9.000 ou 12x R$750; semestral R$6.000 nunca testado |

**Os preços continuam sendo registro factual do que foi praticado.** O que mudou é o enquadramento: Atlas não é definido por ser barato, Overpass não é biblioteca, Vanguarda não é apenas mentoria. A tabela de preços vigente é responsabilidade da operação comercial, não deste registro histórico.

---

## Indicadores econômicos herdados

Medidos sob o recorte anterior de público. **Não usar como critério de qualificação, precificação ou projeção sem revalidação.**
...
A própria documentação anterior já marcava esses valores como pendentes de revalidação.
...
## Dimensionamento de mercado anterior

TAM, SAM e SOM foram levantados sobre o mercado de design e economia criativa e **já estavam marcados como inválidos** na própria documentação anterior, após a primeira mudança de eixo de público.

Permanecem inválidos. Ver **Research & Market Intelligence**.

---

## Mapa de concorrentes anterior

Construído quando o público era descrito como "designers e criadores": escolas de design e branding, plataformas de cursos de escala e substitutos de atenção.

**Status: desatualizado em dois níveis.** Já estava desatualizado sob o recorte de empreendedorismo, e continua desatualizado sob o recorte atual. Os nomes registrados permanecem como registro histórico e podem seguir disputando atenção do mesmo público, mas não representam o vetor de competição atual.
