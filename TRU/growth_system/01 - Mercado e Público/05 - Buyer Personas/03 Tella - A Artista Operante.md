...
## Ela começa tudo com fogo, mas o fogo se apaga antes de virar obra. Talento existe. O que falta é o método que transforma impulso em entrega.

<div style="display:flex;gap:24px;align-items:flex-start">
<div style="flex-shrink:0;display:flex;flex-direction:column;align-items:center;gap:12px;width:200px">
<img src="/brand/images/persona-tella.png" alt="Tella" style="width:200px;border-radius:12px" />
<a href="https://chatgpt.com/g/g-68c46ba30d508191bb57e6272fac6c7d-tella" target="_blank" style="display:inline-block;padding:8px 16px;border-radius:9999px;background:#222;color:#fff;font-size:13px;text-decoration:none;text-align:center;width:100%">Conversar com a Tella</a>
</div>
...
|  | **Maturidade** | Operante |
|  | **Oferta ideal** | Overpass \> ou Protocolo 3-2-1 (downsell) |
...
| **Séries e Filmes** | Maratonou **Euphoria (HBO), Heartstopper (Netflix), Sex Education (Netflix)**. Gosta de filmes cult e estéticos: **Her, Lady Bird, Everything Everywhere All at Once**. Reassiste clássicos da animação: **Studio Ghibli**. |
| **Livros** | Já leu **Roube como um Artista (Austin Kleon)** e cita muito. Segue livros de design e criatividade, mas tem vários incompletos. Sonha em ler **Mulheres que Correm com os Lobos (Clarissa Pinkola Estés)**. Consome mangás/animes como **Attack on Titan, Demon Slayer, Chainsaw Man**. |
| **Moda e Estilo** | Estilo meio **“indie/alternativo”** Lojas: **Renner, C\&A, Shein, Brechós da Augusta**. Usa acessórios artesanais e bolsas criativas (feito por amigos/artistas independentes). |
| **Rotina** | Frequenta **cafeterias independentes em São Paulo** (Coffee Lab, Urbe Café). Gosta de andar na **Paulista aberta aos domingos**. Sai com amigos para **karaokês, rolês em baladas alternativas (Mandíbula, Tokyo SP)**. Usa o tempo livre para ilustrar no **Procreate (iPad de um amigo, quando consegue emprestado)** ou no **Photoshop**. |
...
Usa muito “tipo” e “meio que” para ganhar tempo e disfarçar a insegurança.  
Fala rápido quando está animada, mas com pausas e risadinhas quando fica insegura.  
...
“Não sei se faz sentido, mas…” quando compartilha uma ideia nova.  
“Mano” / “véi” no dia a dia com amigos.  
...
**Feedback construtivo:** Quando um professor ou mentor explica com calma e mostra caminhos de melhoria. Sai animada e com vontade de aplicar na hora.

**Rolês culturais com amigos:** Caminhar na Paulista, visitar exposições no MIS ou no MASP, tomar café em spots “diferentões”. Momentos que alimentam sua criatividade e geram memórias.

**Mimos simples:** Comprar uma canetinha nova, um sketchbook bonito ou um acessório estiloso no brechó. Pequenas conquistas materiais que representam sua identidade criativa.

**Shows e festivais:** Ir a um show da Billie Eilish, Jão ou Rosalía (mesmo se for no YouTube ou TikTok).  
A música a transporta para um lugar de sonho e liberdade.

**Ser ouvida e validada:** Conversar com alguém que realmente presta atenção em suas ideias, sem julgamentos. Isso a faz sentir que “vale a pena continuar”.
