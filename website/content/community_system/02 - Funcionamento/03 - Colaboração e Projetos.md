...
priority: high
ai_when_to_use: |
  Use quando o usuário perguntar como a comunidade da Overlens se conecta a projetos, como times se formam, como funciona o feedback entre membros, como alguém encontra colaboradores ou sócios, ou qual a fronteira entre Community System e Product System nesse tema.
related: ["community_system/01 - Fundamentos/01 - Comunidade como Infraestrutura.md", "community_system/03 - Rituais/02 - Atom Praxis e Hackathons.md", "community_system/02 - Funcionamento/02 - Reputação e Progressão.md"]
---
# Colaboração e Projetos

## Projeto é a unidade central da experiência. Comunidade é a infraestrutura de que um projeto depende e que uma empresa sozinha não consegue fornecer.

Se a lógica pedagógica da Overlens é **projeto → necessidade → conhecimento → aplicação → evidência**, então o projeto é também o ponto onde a comunidade deixa de ser ambiente e passa a ser mecanismo. É aqui que as duas coisas se tocam.

**Fronteira:** projetos, PBL, competências, evidências, progresso e a plataforma que sustenta tudo isso são verdade do **Product System**. Esta página trata apenas do que acontece **entre pessoas** em torno de um projeto.

## O que um projeto precisa e a empresa não fornece
...
**Contexto.** A informação que não está em material nenhum porque depende de alguém que passou por aquilo: quanto custa, quanto demora, o que dá errado, com quem falar.

**Testemunho.** Alguém que acompanhe o suficiente para notar quando o projeto travou. Projetos morrem em silêncio com mais frequência do que morrem por dificuldade técnica.

A comunidade existe, operacionalmente, para tornar esses quatro recursos prováveis.
...
Pessoas se agrupam para construir algo que nenhuma faria sozinha. Um time se forma quando três condições coincidem: um projeto suficientemente definido, capacidades complementares disponíveis e confiança suficiente para começar.

As duas últimas dependem da comunidade. A primeira depende de quem propõe.
...
Uma pergunta única governa as decisões deste tema:

> **Isso aumenta a probabilidade de alguém encontrar o conhecimento certo, a pessoa certa, a ferramenta certa e o contexto certo para avançar um projeto?**

Se sim, é infraestrutura. Se não, é atividade. A diferença é que infraestrutura melhora o resultado de quem a usa, enquanto atividade apenas ocupa o tempo de quem participa.

## Onde este sistema encontra o Product System

| Pergunta | Sistema responsável |
| :---- | :---- |
| Como um projeto é estruturado, acompanhado e avaliado | **Product System** |
| Como evidência de capacidade é registrada | **Product System** |
| Como a plataforma sugere pessoas, conhecimentos e recursos | **Product System** |
| Como pessoas se encontram, colaboram e formam times | **Community System** |
