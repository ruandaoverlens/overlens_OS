---
title: Reputação e Progressão
summary: Distingue reputação de gamificação e registra como a reputação de um Atom poderia se construir (por contribuição, por projeto entregue e por ajuda prestada). Trata a gamificação herdada (XP, missões, badges, ofensiva, ranking, fractais, certificados) como possibilidade de implementação, não como mecanismo de valor, e marca todo o conjunto como hipótese.
topics: [reputação, progressão, gamificação, reconhecimento, funcionamento]
keywords: [reputação, progressão, gamificação, XP, missões, badges, ofensiva, ranking, fractais, certificados, contribuição, evidência, capacidade demonstrada, níveis]
priority: medium
ai_when_to_use: |
  Use quando o usuário perguntar como reputação funciona na comunidade da Overlens, qual a diferença entre reputação e gamificação, se existem níveis ou pontos, o que aconteceu com o sistema de XP e badges anterior, ou como progressão poderia ser reconhecida.
related: ["community_system/02 - Funcionamento/03 - Colaboração e Projetos.md", "community_system/01 - Fundamentos/02 - Ser um Atom.md", "business_doc/04 - Estratégia/01 - Moats.md"]
---
