...
priority: high
ai_when_to_use: |
  Use quando o usuário perguntar sobre o mercado da Overlens, em que setor ou categoria a marca opera, qual o panorama estratégico, ou como navegar a estrutura da seção Mercado e Público (Segmento, TAM/SAM/SOM, Público-Alvo, Perfil Ideal).
related: []
---
...
A companhia mudou de categoria, e parte desta seção ainda não alcançou a mudança. Vale declarar isso antes de qualquer leitura:
...
Define em que categoria a Overlens é comparada: setor macro (Educação, Tecnologia, Economia Criativa e Entretenimento), subsetor (Edtech, Empreendedorismo, Comunidade) e categoria (**escola de negócios, criação e realização**).
...
Define o recorte de dimensionamento sob o público atual e registra que **os números seguem pendentes**. O recorte já ficou inválido duas vezes; a página existe para impedir que ele seja preenchido por suposição uma terceira.

### Público-Alvo

Descreve quem é o público pela **regra de estado**: condição em relação à ideia, não cargo, formação ou senioridade. A versão em base ainda reflete a leitura anterior e **necessita revisão de persona**.
...
A seção "Mercado" é a base sobre a qual todo o resto do Growth System se apoia. Ela ganha valor na proporção em que for honesta sobre a diferença entre o que foi decidido, o que está em teste e o que ainda não foi pesquisado. Um mercado bem descrito orienta; um mercado inventado custa caro e demora a ser desmentido.
