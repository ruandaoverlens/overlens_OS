...
## Ele sente que o mundo está mudando, mas ainda não sabe por onde começar. Curiosidade sobra. Direção, ainda não. Brunin representa o início da jornada: um jovem criativo perdido entre tutoriais infinitos e promessas vazias, preso entre a ansiedade de ficar para trás e a vontade silenciosa de construir algo que seja seu.

<div style="display:flex;gap:24px;align-items:flex-start">
<div style="flex-shrink:0;display:flex;flex-direction:column;align-items:center;gap:12px;width:200px">
<img src="/brand/images/persona-brunin.png" alt="Brunin" style="width:200px;border-radius:12px" />
<a href="https://chatgpt.com/g/g-68c58b8e3a5081919a0e2241fb6c40ec-brunin" target="_blank" style="display:inline-block;padding:8px 16px;border-radius:9999px;background:#222;color:#fff;font-size:13px;text-decoration:none;text-align:center;width:100%">Conversar com o Brunin</a>
</div>
...
| **Séries e Filmes** | Netflix: Sex Education, Heartstopper, The End of the F\*\*ing World\*. Filmes de estética cult: Lady Bird, Scott Pilgrim vs. The World. Animações da Pixar e alguns animes populares (Demon Slayer). |
| **Livros** | Tentou ler Roube como um Artista, mas parou no meio. Guarda PDFs de livros de marketing/design que nunca terminou. Curiosidade por títulos de autodesenvolvimento, mas não cria hábito. |
| **Moda e Estilo** | Veste fast fashion acessível (Renner, C\&A, Shopee). Gosta de camisetas com estampas de bandas e animes. Sonha em ter estilo mais alternativo, mas se sente inseguro em ousar. |
| **Rotina** | Vai para a faculdade à tarde/noite, passa o resto do tempo em casa consumindo conteúdo. Estuda em bibliotecas/cafeterias baratas quando quer se sentir “produtivo”. Sai com amigos para shoppings e bares simples. Tenta pegar freelas de social media e design, mas sem consistência. |
...
* Fala rápido quando tá empolgado, mas enrola quando fica inseguro.  
...
* “Tá ligado?” no final das frases, buscando validação.  
* “Ai, sei lá…” quando não sabe explicar.  
* “Não sei se faz sentido, mas…” quando solta uma ideia confusa.  
