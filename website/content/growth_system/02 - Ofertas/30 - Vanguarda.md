---
title: Vanguarda
summary: "Vanguarda é a camada de aceleração da Overlens: programa de alta intensidade, proximidade e transformação para quem já tem algo existindo e precisa fazê-lo avançar. Esta página trata de posicionamento, argumento e jornada de compra; a definição da oferta pertence ao Business Document."
topics: [vanguarda, aceleração, alta intensidade, incubação, jornada de compra, posicionamento de oferta]
keywords: [vanguarda, aceleração, incubação, alta intensidade, lean, entropia, direção, validação, caixa, previsibilidade, equipe, processos, expansão, comunidade de alto envolvimento, ficha técnica]
priority: high
ai_when_to_use: |
  Use quando o usuário perguntar sobre a Vanguarda, camada de aceleração da Overlens, como posicionar e vender uma oferta de alta intensidade, diferença entre aceleração e incubação, os 8 níveis do programa, histórico de preços praticados, ou como alguém decide entrar na camada de aceleração.
related: [growth_system/02 - Ofertas/23 - Ofertas, growth_system/02 - Ofertas/29 - Overpass]
---
# Vanguarda
