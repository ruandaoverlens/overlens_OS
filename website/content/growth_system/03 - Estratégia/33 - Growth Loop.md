...
* **Códices (MIFGE)**: Experiências iniciais gratuitas e simbólicas ligadas ao universo Parallax.  
* **Lives**: Conteúdos ao vivo que apresentam a filosofia e as propostas da Overlens.  
* **Conteúdo**: Artigos, vídeos e postagens de redes sociais, que despertam curiosidade intelectual.  
* **Conteúdo Evergreen**: Materiais atemporais para captar usuários organicamente via SEO.  
* **Prisma**: Provavelmente conteúdos visuais/narrativos que reforçam o imaginário da Overlens.  
* **SEO e ADS**: Estratégias pagas e orgânicas para captação de novos interessados.

**Estado emocional do usuário:**

* Curiosidade e interesse por uma proposta diferente e simbólica de formação criativa.  
...
**Como acontece:** Após clicar em um conteúdo externo, o usuário cria uma conta gratuita ou resgata um Códice. Assim que entra na plataforma, ele é impactado por elementos de ativação:

* **Emails de boas-vindas**: Orientam os primeiros passos.  
  * **Notificações internas**: Chamam a atenção para a primeira missão.  
  * **Banners, Botões e Faixas**: Guiam o usuário visualmente para consumir sua primeira aula/missão.  
  * **Popups estratégicos**: Incentivam a tomar ações rápidas.  
  * **Paywall**: Limita o acesso premium, incentivando a avançar na jornada gratuita.

**Primeiro Momento de Sucesso:**

* Consumo da **primeira aula** \+ **primeira missão** (entrega de uma pequena vitória como badge ou desbloqueio de item simbólico).
...
* **Ofensiva**: Um modo de engajamento que parece criar "momentum" narrativo (ex: missões contínuas, histórias).  
  ...
  * **Desafios**: Tarefas gamificadas que estimulam o usuário a aplicar o que aprendeu.  
...
* **MIFGE** (alguma extensão paga dos Códices).  
  * **Overpass** (provavelmente um plano de assinatura mensal que desbloqueia recursos avançados).  
...
* **Indique e Ganhe**: Usuários que convidam novos participantes ganham itens exclusivos.  
  * **UGC (User Generated Content)**: Usuários que criam conteúdo sobre a Overlens também recebem itens ou desbloqueiam conteúdos especiais.  
...
1. **Aquisição:**Conhece a Overlens por um Códice, conteúdo ou campanha.  
