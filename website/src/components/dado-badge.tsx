...
export function DadoBadge({
  ...
  return (
    <span className="ms-1.5 -my-1 inline-flex -translate-y-[0.18em] items-center gap-1 align-baseline">
      {grade && info && (
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            ...
            className={`inline-flex size-[1.75em] shrink-0 cursor-help items-center justify-center rounded-full font-body text-[0.8em] font-semibold leading-none transition-opacity hover:opacity-80 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring ${info.dotClass}`}
          >
            {grade}
          </button>
        </TooltipTrigger>
          ...
          <TooltipTrigger asChild>
            {isLink ? (
              <a
                ...
                className="inline-flex size-[1.75em] shrink-0 items-center justify-center rounded-full bg-muted font-body text-[0.8em] font-semibold leading-none text-muted-foreground no-underline transition-opacity hover:opacity-80 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
              >
                F
              </a>
            ) : (
              <button
                type="button"
                aria-label={`Fonte: ${fonte}`}
                className="inline-flex size-[1.75em] shrink-0 cursor-help items-center justify-center rounded-full bg-muted font-body text-[0.8em] font-semibold leading-none text-muted-foreground transition-opacity hover:opacity-80 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
              >
                F
              </button>
            )}
