...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "data-[placeholder]:text-muted-foreground [&_svg:not([class*='text-'])]:text-muted-foreground aria-invalid:border-destructive bg-input/30 border-2 border-field-border hover:bg-input/50 focus-visible:border-foreground/70 aria-invalid:focus-visible:border-destructive focus-visible:bg-transparent data-[state=open]:border-field-border data-[state=open]:bg-transparent flex w-full items-center justify-between gap-2 py-0 font-medium font-body whitespace-nowrap shadow-none transition-all outline-none ring-0 select-none disabled:cursor-not-allowed disabled:opacity-50 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-6",
