...
/** Configuration object mapping data keys to labels, icons, and colors for charts. */
...
/** Hook that provides the chart configuration context. */
function useChart() {
...
/** Responsive chart wrapper that provides configuration context and CSS variables. */
...
/** Injects CSS custom properties for chart colors based on theme. */
...
/** Styled tooltip content renderer with color indicators and labels. */
...
/** Styled legend content renderer with color swatches and labels. */
